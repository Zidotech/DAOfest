...
const Card = () => {
  return (
    <section className="section">
      <div className=" py-16 flex gap-x-5 gap-y-7 flex-wrap justify-around">
        <div className="card flex flex-col justify-between gap-y-5 sm:w-[380px] w-full ">
          ...
          <p className="text-black font-Poppins font-medium">
            ...
            go-to DAO event of the year, you'll amplify your brand's reach,
            connect with thought leaders, and contribute to the celebration of
            the potential of Decentralized Autonomous Organizations. Join us in
            empowering communities and individuals for sustainable development,
            becoming a catalyst for change in the decentralized revolution.
            Shape the future of innovation by sponsoring DAOfest.
          </p>
          <Link
            target="_blank"
            to={
        ...
        <div className="card flex flex-col justify-between gap-y-5 sm:w-[380px] w-full">
          ...
          <p className="text-black font-Poppins  pb-5 font-medium">
            ...
            distinguished speaker and leave a lasting impact on the
        ...
        <div className="card flex flex-col  justify-between gap-y-5 sm:w-[380px] w-full ">
          ...
          <Link
            target="_blank"
            to={
              "https://app.deform.cc/form/dcbc5709-5f6d-4dce-a366-b194c0861154"
            }
          >
            <button className="py-[14px] sm:px-[78px] px-12 bg-Primary text-[16px] font-Poppins rounded-2xl text-White">
              Apply To Pitch
